...
def main():
    ...
    df_train = pd.read_csv('data/Quora/train_features.csv', encoding="ISO-8859-1")
    ...
    df_test = pd.read_csv('data/Quora/test_features.csv', encoding="ISO-8859-1")
    ...
    sub.to_csv('submission/' + args.save + '.csv')
